module Sidekiq::Status::Storage
  ...
  def store_for_id(id, status_updates, worker_class = nil, expiration = nil, redis_pool=nil)
    ...
    redis_connection(redis_pool) do |conn|
      conn.multi do
        ...
        conn.sadd("#{Sidekiq::Status::AsCollection::NAMESPACE}:#{worker_class.downcase}", namespaced_key) if worker_class
